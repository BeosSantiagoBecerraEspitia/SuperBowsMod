...
import net.beosbecerra.superbowsmod.entity.FrozenArrow;
...
public class FrozenBow extends BowItem {
    ...
    public FrozenBow(Item.Properties properties) {
        super(properties);
    }
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity shooter, int timeLeft) {
        ...
        if (!level.isClientSide) {
            FrozenArrow arrow = new FrozenArrow(ModEntities.FROZEN_ARROW.get(), level, shooter);
